...
@section('metadesc') Get your {{$color->model->brand->name}} {{ $color->model->series }} {{$color->model->name}} screen replaced at your doorstep in Chennai, Bangalore within 30 minutes. Book appointment now! @endsection
@section('breadcrumb')
                ...
                <div class="breadcaump-inner text-center">
                    ...
                    <div class="breadcrumb-insite">
                        <ul class="core-breadcaump">
                            ...
                            <li><a href="/{{ $color->model->brand->name }}-screen-service-center">{{ $color->model->brand->name }} Screen Repairs</a></li>
