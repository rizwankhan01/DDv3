...
<ul class="vertical-menu">
    ...
    <li><a href="#" title="New Model Requests">
      <img src="{{ asset('assets\images\svg-icon\dashboard.svg') }}" class="img-fluid" alt="models"><span>Model Request</span>
    </a></li>
    <li><a href="/dealers" title="Dealers + History + Accounts">
      <img src="{{ asset('assets\images\svg-icon\dashboard.svg') }}" class="img-fluid" alt="models"><span>Dealers</span>
    </a></li>
    <li><a href="#" title="Replacements">
      <img src="{{ asset('assets\images\svg-icon\dashboard.svg') }}" class="img-fluid" alt="models"><span>Tickets</span>
    </a></li>
    <li><a href="#" title="Overall Accounts">
      <img src="{{ asset('assets\images\svg-icon\dashboard.svg') }}" class="img-fluid" alt="models"><span>Accounts</span>
    </a></li>
    <li><a href="/settings">
