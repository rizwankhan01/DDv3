...
<ul class="vertical-menu">
    ...
    <li><a href="/crmhome">
      <img src="{{ asset('assets\images\svg-icon\dashboard.svg') }}" class="img-fluid" alt="dashboard"><span>Home</span>
    </a></li>
    <li><a href="/newenq">
      <img src="{{ asset('assets\images\svg-icon\dashboard.svg') }}" class="img-fluid" alt="closed"><span>Leads</span>
    </a></li>
    <li><a href="/tickets">
      <img src="{{ asset('assets\images\svg-icon\dashboard.svg') }}" class="img-fluid" alt="brands"><span>Tickets</span>
    </a></li>
    <li><a href="/customers">
    ...
    <li><a href="/newmail">
      <img src="{{ asset('assets\images\svg-icon\dashboard.svg') }}" class="img-fluid" alt="models"><span>My Mails</span>
    </a></li>
    <li><a href="#">
      <img src="{{ asset('assets\images\svg-icon\dashboard.svg') }}" class="img-fluid" alt="models"><span>Messages</span>
    </a></li>
    <li><a href="/settings">
